...
export class MongoClient extends TypedEventEmitter<MongoClientEvents> implements AsyncDisposable {
  ...
  private async _close(): Promise<void> {
    // There's no way to set hasBeenClo                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ons.clear();
   ...
   * emit an error event that returns a MongoOperationTimeoutError, but will no                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                hole change stream document emitted
   */
  watch<
